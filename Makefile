...
TESTSRC = tests/CryptoKernelTestRunner.cpp tests/CryptoTests.cpp tests/SchnorrTests.cpp tests/MathTests.cpp tests/MerkletreeTests.cpp tests/LogTests.cpp tests/StorageTests.cpp
